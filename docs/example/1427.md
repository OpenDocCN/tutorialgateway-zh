...
> 原文:[https://www . tutorialgateway . org/Java-program-to-print-8-star-pattern/](https://www.tutorialgateway.org/java-program-to-print-8-star-pattern/)

编写一个 Java 程序，使用 for 循环打印 8 星图案。
...
<figure class="wp-block-image size-large">![Java Program to Print 8 Star Pattern](../Images/409fda4205efb09e066ad5bf24a69053.png)</figure>

## 使用 while 循环打印 8 星图案的 Java 程序
...
这个 Java 程序使用 do while 循环来打印 8 位星形模式。
