# 检查三角形是否有效的 Python 程序

> 原文:[https://www . tutorialgateway . org/python-要检查的程序-三角形-是有效还是无效/](https://www.tutorialgateway.org/python-program-to-check-triangle-is-valid-or-not/)
