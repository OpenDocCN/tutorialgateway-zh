# 打印直角递减数字图案方块的 Java 程序

> 原文:[https://www . tutorialgateway . org/Java-program-to-print-right-square-减量-numbers-pattern/](https://www.tutorialgateway.org/java-program-to-print-square-of-right-decrement-numbers-pattern/)
