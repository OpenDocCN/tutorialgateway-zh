...
> 原文:[https://www . tutorialgateway . org/Java-program-to-print-v-star-pattern/](https://www.tutorialgateway.org/java-program-to-print-v-star-pattern/)

编写一个 Java 程序，使用 for 循环打印 V 星图案。
...
<figure class="wp-block-image size-large">![Java Program to Print V Star Pattern](../Images/7829ed828824f1d5985b5f8b9731c3bb.png)</figure>

## 用 while 循环打印 V 星图案的 Java 程序
