# 在正方形的所有边上打印相同数字的 Java 程序

> 原文:[https://www . tutorialgateway . org/Java-program-to-print-正方形四面相同的数字/](https://www.tutorialgateway.org/java-program-to-print-same-numbers-on-all-sides-of-a-square/)
...
<figure class="wp-block-image size-large">![Java Program to Print Same Numbers on all Sides of a Square](../Images/b495dfe8cf3cb863b59a80ce848618ad.png)</figure>
