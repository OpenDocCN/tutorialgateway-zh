...
> 原文:[https://www . tutorialgateway . org/c-program-替换字符串中第一个出现的字符/](https://www.tutorialgateway.org/c-program-to-replace-first-occurrence-of-a-character-in-a-string/)
