# 计算列表中偶数和奇数的 Python 程序

> 原文:[https://www . tutorialgateway . org/python-程序对列表中的偶数和奇数进行计数/](https://www.tutorialgateway.org/python-program-to-count-even-and-odd-numbers-in-a-list/)
