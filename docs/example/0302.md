...
> 原文:[https://www . tutorialgateway . org/c-program-to-print-w-star-pattern/](https://www.tutorialgateway.org/c-program-to-print-w-star-pattern/)

写一个 C 程序打印 W 星形图案用于循环。在这段 C 代码中，printingStars 函数迭代并打印星星，printingSpaces 打印空格以打印 W 形状。
...
<figure class="wp-block-image size-large">![C Program to Print W Star Pattern](../Images/bd451a9c920d4b6643a4c8f4bd447894.png)</figure>

这个 C 程序使用 while 循环来显示 W 星形模式。
