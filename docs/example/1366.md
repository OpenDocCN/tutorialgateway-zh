...
> 原文:[https://www . tutorialgateway . org/Java-program-to-find-sum-matrix-对立-对角/](https://www.tutorialgateway.org/java-program-to-find-sum-of-matrix-opposite-diagonal/)
