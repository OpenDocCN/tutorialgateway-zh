...
> 原文:[https://www . tutorialgateway . org/CPP-program-to-print-hollow-sandglass-star-pattern/](https://www.tutorialgateway.org/cpp-program-to-print-hollow-sandglass-star-pattern/)
...
<figure class="wp-block-image size-large">![C++ Program to Print Hollow Sandglass Star Pattern](../Images/7d48980d1420650d0e0de071c575fae2.png)</figure>
...
## 使用 do while 循环打印空心沙漏星形图案的 C++程序
