...
> 原文:[https://www . tutorialgateway . org/Java-程序转打印-空心-镜像-菱形-星形-图案/](https://www.tutorialgateway.org/java-program-to-print-hollow-mirrored-rhombus-star-pattern/)

写一个 Java 程序来打印空心镜像菱形星形图案，用于循环。这个 Java 中空镜像菱形模式示例使用多个 if-else 语句和嵌套循环来迭代和打印中空镜像菱形。
...
<figure class="wp-block-image size-large">![Java Program to Print Hollow Mirrored Rhombus Star Pattern 1](../Images/a0171fc88ab9e11de336b837c8514aff.png)</figure>

在这个 Java 中空镜像菱形星形模式程序中，我们将循环的[替换为](https://www.tutorialgateway.org/java-for-loop/)[而循环](https://www.tutorialgateway.org/java-while-loop/)。
