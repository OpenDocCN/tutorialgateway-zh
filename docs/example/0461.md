...
> 原文:[https://www . tutorialgateway . org/CPP-program-to-print-Christmas-tree-star-pattern/](https://www.tutorialgateway.org/cpp-program-to-print-christmas-tree-star-pattern/)

写一个 C++程序，用 for 循环打印圣诞树星形图案。
...
<figure class="wp-block-image size-large">![C++ Program to Print Christmas Tree Star Pattern](../Images/8457ef8bf4ac571801c0034d7d60dfd9.png)</figure>
