...
> 原文:[https://www . tutorialgateway . org/c-program-to-remove-字符串中第一个出现的字符/](https://www.tutorialgateway.org/c-program-to-remove-first-occurrence-of-a-character-in-a-string/)
