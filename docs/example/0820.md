# 检查数字的 Python 程序是一个 Krishnamurthy 数字

> 原文:[https://www . tutorialgateway . org/python-program-to-check-number-is-krishnamurthy-number/](https://www.tutorialgateway.org/python-program-to-check-the-number-is-a-krishnamurthy-number/)
