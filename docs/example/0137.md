...
> 原文:[https://www . tutorialgateway . org/c-program-to-remove-最后一次出现字符串中的字符/](https://www.tutorialgateway.org/c-program-to-remove-last-occurrence-of-a-character-in-a-string/)
