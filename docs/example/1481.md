...
> 原文:[https://www . tutorialgateway . org/Java-程序-打印-左箭头-字母-模式/](https://www.tutorialgateway.org/java-program-to-print-left-arrow-alphabets-pattern/)

编写一个 Java 程序，使用 for 循环打印左箭头字母模式。
...
<figure class="wp-block-image size-large">![Java Program to Print Left Arrow Alphabets Pattern](../Images/f4d609af1caa83ec4ff201e1b30f0a48.png)</figure>
