# 计算列表中正数和负数的 Python 程序

> 原文:[https://www . tutorialgateway . org/python-程序到计数-列表中的正数和负数/](https://www.tutorialgateway.org/python-program-to-count-positive-and-negative-numbers-in-a-list/)
