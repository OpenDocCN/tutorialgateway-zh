...
> 原文:[https://www . tutorialgateway . org/CPP-program-to-print-right-square-increment-numbers-pattern/](https://www.tutorialgateway.org/cpp-program-to-print-square-of-right-increment-numbers-pattern/)
