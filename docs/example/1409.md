# 打印左帕斯卡星形三角形的 Java 程序

> 原文:[https://www . tutorialgateway . org/Java-program-to-print-left-Pascal-star-triangle/](https://www.tutorialgateway.org/java-program-to-print-left-pascals-star-triangle/)
