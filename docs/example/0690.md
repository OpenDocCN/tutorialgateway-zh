...
> 原文:[https://www . tutorialgateway . org/go-program-to-print-rectangle-number-pattern/](https://www.tutorialgateway.org/go-program-to-print-rectangle-number-pattern/)
