# 打印圣诞树星形图案的 Python 程序

> 原文:[https://www . tutorialgateway . org/python-program-to-print-Christmas-tree-star-pattern/](https://www.tutorialgateway.org/python-program-to-print-christmas-tree-star-pattern/)

编写一个 Python 程序，使用 for 循环打印圣诞树星形图案。
...
<figure class="wp-block-image size-large">![Python Program to Print Christmas Tree Star Pattern](../Images/826bf089f12d509d681395cf84518c6d.png)</figure>
