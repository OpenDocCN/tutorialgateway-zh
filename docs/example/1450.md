...
> 原文:[https://www . tutorialgateway . org/Java-program-to-print-right-Pascal-三角镜数字-pattern/](https://www.tutorialgateway.org/java-program-to-print-right-pascals-triangle-of-mirrored-numbers-pattern/)

编写一个 Java 程序，使用 for 循环打印镜像数字模式的右帕斯卡三角形。
...
<figure class="wp-block-image size-large">![Java Program to Print Right Pascals Triangle of Mirrored Numbers Pattern](../Images/bf0c0d63717bec405f1354f4f122fc15.png)</figure>
