...
> 原文:[https://www.tutorialgateway.org/method-overloading-in-java/](https://www.tutorialgateway.org/method-overloading-in-java/)
...
我们已经看到了许多 Java 方法重载技术，但是您可能没有注意到。例如，数组。我们在上一篇文章中解释的排序函数或 System.out.println 方法，它接受多种数据类型作为参数。Java 方法重载可以通过以下方式实现
