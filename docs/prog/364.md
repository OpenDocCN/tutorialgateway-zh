...
> 原文:[https://www . tutorialgateway . org/after-insert-triggers-in-SQL-server/](https://www.tutorialgateway.org/after-insert-triggers-in-sql-server/)
...
这里，我们使用[插入选择语句](https://www.tutorialgateway.org/sql-insert-into-select-statement/)来选择所有插入到雇员表中的记录。然后，我们将这些记录插入到审计表中。
