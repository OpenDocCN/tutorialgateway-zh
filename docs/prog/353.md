...
> 原文:[https://www . tutorialgateway . org/alter-user-defined-functions-in-SQL/](https://www.tutorialgateway.org/alter-user-defined-functions-in-sql/)
...
提示:您也可以通过添加:smo 来返回函数定义。选择语句中的定义。
