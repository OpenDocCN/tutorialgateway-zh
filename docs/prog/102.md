...
> 原文:[https://www.tutorialgateway.org/c-sqrt-function/](https://www.tutorialgateway.org/c-sqrt-function/)

C sqrt 函数是数学函数之一，用来求一个数或一个指定表达式的平方根。C 编程语言中 sqrt 的语法是
...
在这个 [C 编程](https://www.tutorialgateway.org/c-programming/)的例子中，我们允许用户输入自己的值。接下来，这个[程序](https://www.tutorialgateway.org/c-programming-examples/)使用 sqrt 函数来寻找用户给定数字的平方根。
