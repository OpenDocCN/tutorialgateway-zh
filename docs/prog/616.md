...
> 原文:[https://www.tutorialgateway.org/mysql-date-functions/](https://www.tutorialgateway.org/mysql-date-functions/)
...
| [CONVERT_TZ()](https://www.tutorialgateway.org/mysql-convert_tz-function/) | 这个 MySQL Date 函数将日期和时间从一个时区转换到另一个时区。 |
| 库尔德语() | 返回当前日期 |
...
在这个 MySQL Date 函数示例中，我们将使用 [DATE](https://www.tutorialgateway.org/mysql-date-functions/) 获取日期，并使用 [DATEDIFF](https://www.tutorialgateway.org/mysql-datediff-function/) 查找两个日期之间的差异。接下来，我们使用[日期 _ 添加](https://www.tutorialgateway.org/mysql-date_add-function/)来添加日期间隔。
