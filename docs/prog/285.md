...
> 原文:[https://www.tutorialgateway.org/bulk-insert-in-sql-server/](https://www.tutorialgateway.org/bulk-insert-in-sql-server/)
...
我们有一个名为 GEOGRAPHY.txt 的平面文件，包含 1000000 行。我们的任务是使用 Sql Server 批量插入语句插入该文本文件中的所有行。
