...
C log10 函数是 C 数学函数之一，用于计算基数为 10 的数的对数值。C 编程中数学日志 10 的语法是
...
在这个 [C 编程](https://www.tutorialgateway.org/c-programming/)的例子中，我们允许用户输入自己的值。接下来，[程序](https://www.tutorialgateway.org/c-programming-examples/)使用 log10 函数找到以 10 为基数的用户给定数字的对数值。
