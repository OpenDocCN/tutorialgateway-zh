...
> 原文:[https://www.tutorialgateway.org/sql-subquery/](https://www.tutorialgateway.org/sql-subquery/)
...
嵌套查询也应用于插入到选择语句中。如何在 SQL Insert 语句中编写子查询，将新记录插入到员工表中。
...
嵌套在[插入选择语句](https://www.tutorialgateway.org/sql-insert-into-select-statement/)中的输出是
