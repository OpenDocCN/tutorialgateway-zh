...
> 原文:[https://www.tutorialgateway.org/python-math-functions/](https://www.tutorialgateway.org/python-math-functions/)
...
| [功率(x)](https://www.tutorialgateway.org/python-pow/) | 这个 Python 幂和对数函数计算指定表达式的幂 |
