...
> 原文:[https://www.tutorialgateway.org/sql-inner-join/](https://www.tutorialgateway.org/sql-inner-join/)
...
请将所需的列放在[选择语句](https://www.tutorialgateway.org/sql-select-statement/)之后，以避免内部[连接](https://www.tutorialgateway.org/sql-joins/)中不需要的列。
